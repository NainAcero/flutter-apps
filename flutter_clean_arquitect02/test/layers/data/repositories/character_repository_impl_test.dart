...
class CharacterLocalDatasourceMock extends Mock implements CharacterLocalDatasource {}

class CharacterNetworkDatasourceMock extends Mock implements CharacterNetworkDatasource {}
