...
import 'package:flutter_clean_arquitect_whatsapp/data/datasource/firebase_remote_datasource.dart';
import 'package:flutter_clean_arquitect_whatsapp/data/datasource/firebase_remote_datasource_impl.dart';
import 'package:flutter_clean_arquitect_whatsapp/data/local_datasource/local_datasource.dart';
import 'package:flutter_clean_arquitect_whatsapp/data/repositories/firebase_repository_impl.dart';
import 'package:flutter_clean_arquitect_whatsapp/data/repositories/get_device_number_repository_impl.dart';
...
import 'package:flutter_clean_arquitect_whatsapp/domain/usecases/add_to_my_chat_usecase.dart';
...
import 'package:flutter_clean_arquitect_whatsapp/domain/usecases/get_one_to_one_single_user_chat_channel_usecase.dart';
import 'package:flutter_clean_arquitect_whatsapp/domain/usecases/get_text_messages_usecase.dart';
import 'package:flutter_clean_arquitect_whatsapp/domain/usecases/is_sign_in_usecase.dart';
import 'package:flutter_clean_arquitect_whatsapp/domain/usecases/send_text_message_usecase.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton<GetTextMessagesUseCase>(() => GetTextMessagesUseCase(repository: sl.call()));
  ...
  sl.registerLazySingleton<CreateOneToOneChatChannelUseCase>(() => CreateOneToOneChatChannelUseCase(repository: sl.call()));
  sl.registerLazySingleton<GetOneToOneSingleUserChatChannelUseCase>(() => GetOneToOneSingleUserChatChannelUseCase(repository: sl.call()));
  sl.registerLazySingleton<GetDeviceNumberUseCase>(() => GetDeviceNumberUseCase(deviceNumberRepository: sl.call()));

  //repository
  sl.registerLazySingleton<FirebaseRepository>(() => FirebaseRepositoryImpl(remoteDataSource: sl.call()));
  sl.registerLazySingleton<GetDeviceNumberRepository>(() => GetDeviceNumberRepositoryImpl(localDataSource: sl.call()));
